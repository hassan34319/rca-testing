...
export const _id = [...Array(40)].map(
  (_, index) => `puedeserqualcosa${index + 1}`
);

export const _courseTitle = [
  'Factor ETF & Investing',
  'Stock Investing',
  'Orderflow trading con Bookmap',
...
export const _postTitles = [
  '10 Estrategias para una Gestión Financiera Exitosa',
  'La Guía Definitiva de Inversiones Rentables',
  'Explorando Oportunidades de Negocio en [Mercado Financiero]',
  'Cómo Planificar una Jubilación Financieramente Segura',
  'El Futuro de las Criptomonedas: Tendencias e Implicaciones',
  'Consejos para una Gestión de Deudas Inteligente',
  'Guía para Principiantes sobre Análisis de Mercados Financieros',
  'El Impacto de la Economía Global en las Finanzas Personales',
  '10 Claves para una Inversión Inmobiliaria Exitosa',
  'Los Beneficios de la Diversificación de Carteras de Inversión',
  'La Importancia de la Educación Financiera desde Temprana Edad',
  'Construyendo una Sólida Estrategia de Ahorro a Largo Plazo',
  '10 Estrategias Efectivas para Proteger tus Activos Financieros',
  'Desvelando los Secretos de Emprendedores Financieramente Exitosos',
  'El Auge de las Finanzas Sostenibles y su Impacto en las Empresas',
  'El Arte de la Negociación Financiera: Técnicas e Inspiración',
  'Comprendiendo los Mercados Bursátiles y su Funcionamiento',
  'Cómo Crear un Presupuesto Efectivo para Administrar tus Finanzas',
  'El Papel de la Tecnología en la Transformación Financiera',
  '10 Estrategias para Proteger tus Finanzas en Tiempos de Crisis',
  'Explorando la Historia de las Instituciones Financieras',
  'El Poder de las Inversiones con Impacto Social y Ambiental',
  'La Influencia de la Psicología en las Decisiones Financieras',
  'Consejos para una Jubilación Temprana y Financieramente Libre',
];
...
export const _taskNames = [
  ...
  'Diseñar Plantilla de Boletín de Correo Electrónico',
  'Monitorear Registros del Servidor en busca de Errores',
  'Crear Materiales de Capacitación',
  'Planificar y Ejecutar Campaña de Marketing',
...
export const _sentences = [
  'El sol se puso lentamente sobre el horizonte, pintando el cielo con vibrantes tonos de naranja y rosa.',
  'Abrió el regalo con entusiasmo, sus ojos brillaban de emoción.',
  'El viejo roble se alzaba alto y majestuoso, sus ramas meciéndose suavemente en la brisa.',
  'El aroma del café recién hecho llenaba el aire, despertando mis sentidos.',
  'Los niños reían con alegría mientras corrían entre los aspersores en un caluroso día de verano.',
  'Con habilidad, esculpió una hermosa escultura de arcilla, sus manos dando forma a los intrincados detalles.',
  'El concierto fue una experiencia fascinante, con la música llenando el lugar y la multitud aclamando con deleite.',
  'Las olas chocaban contra la orilla, creando una relajante sinfonía de sonidos.',
  'El aroma de las flores en flor flotaba en el jardín, creando un paraíso fragante.',
  'Miró hacia el cielo nocturno, maravillándose de las estrellas titilantes que salpicaban la oscuridad.',
  'El profesor impartió una conferencia cautivadora, involucrando a los estudiantes con ideas estimulantes.',
  'El excursionista atravesó el denso bosque, guiado por el suave resplandor del sol que se filtraba entre los árboles.',
  'La delicada mariposa revoloteaba con gracia de flor en flor, bebiendo néctar con su delgado probóscide.',
  'El aroma de las galletas recién horneadas llenaba la cocina, tentando a todos con su irresistible fragancia.',
  'La majestuosa cascada caía en cascada por las rocas, creando una impresionante muestra del poder de la naturaleza.',
  'El actor ofreció una actuación poderosa, conmoviendo al público hasta las lágrimas con su emotiva interpretación.',
  'El libro me transportó a un mundo mágico, donde la imaginación no tenía límites.',
  'El aroma de la lluvia llenaba el aire mientras las nubes oscuras se reunían en el cielo, prometiendo un refrescante aguacero.',
  'El chef hábilmente emplató el plato, convirtiendo ingredientes simples en una obra de arte culinario.',
  'El recién nacido emitió un pequeño llanto, anunciando su llegada al mundo.',
  'El atleta corrió a toda velocidad cruzando la línea de meta, con los brazos en alto en señal de victoria mientras la multitud estallaba en aplausos.',
  'Las antiguas ruinas permanecían como testimonio de una civilización ya desaparecida, su grandeza todavía impresionante.',
  'El artista sumergió el pincel en pintura vibrante, dando vida al lienzo con trazos audaces y colores vivos.',
  'La risa de los niños resonaba en el patio de recreo, llenando el ambiente de pura alegría.',
];
