...
const cardData = [
  ...
  export default function ElearningMentoriasInvesting() {
    return (
      <Box
        sx={{
          py: { xs: 4, md: 4 },
      ...
      >
        <Container>
          <Grid container spacing={{ xs: 8, md: 3 }} justifyContent="center" alignItems="center" flexDirection="column">
            ...
            >
              <Typography>
              Toda nuestra tecnología y experiencia a tu servicio para diseñar, optimizar y maximizar los resultados de tu portafolio personal o familiar.
              </Typography>
              </Box>
